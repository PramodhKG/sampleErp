...
class po_indent_to_order_wizard(osv.osv_memory):
		
	_name = 'po.indent.to.order.wizard'
	_columns = {
		
		'product_id': fields.many2many('product.product','po_indent_order','order_id','pro_id','Product Name'),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'po.indent.order', 'datas': data}	
		

po_indent_to_order_wizard()
