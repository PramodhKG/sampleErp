...
class po_to_grn_wizard(osv.osv_memory):
		
	_name = 'po.to.grn.wizard'
	_columns = {
		
		'product_id': fields.many2many('product.product','po_to_grn','order_id','pro_id','Product Name'),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'po.order.grn', 'datas': data}	
