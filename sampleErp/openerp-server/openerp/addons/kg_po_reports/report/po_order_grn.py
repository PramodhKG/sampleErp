...
class po_order_grn(report_sxw.rml_parse):
	...
	def __init__(self, cr, uid, name, context=None):
		if context is None:
			context = {}
		super(po_order_grn, self).__init__(cr, uid, name, context=context)
		self.query = ""
		self.period_sql = ""
...
report_sxw.report_sxw('report.po.order.grn','stock.picking',
						'addons/kg_purchase_order/report/po_order_grn.rml',
						parser=po_order_grn, header= False)
