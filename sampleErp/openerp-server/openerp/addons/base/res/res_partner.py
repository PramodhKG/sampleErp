...
class res_partner(osv.osv, format_address):
	...
	_columns = {
		...
		'segment': fields.selection([('domestic', 'Domestic'), ('export', 'Export'),
								 ('other', 'Other')], 'Segment'),
		'supplier_status':fields.selection([('approve', 'Approve'), ('not_approve', 'Not Approve')], 'Supplier Status'),
		'sms_status':fields.selection([('True', 'True'), ('False', 'False')], 'SMS Status'),
		'email_status':fields.selection([('True', 'True'), ('False', 'False')], 'Email Status'),
