...
class kg_employee_payslip_wiz(osv.osv_memory):
	_name = 'kg.employee.payslip.wiz'
	_columns = {
		
		'dep_id':fields.many2many('hr.department','kg_employee_payslip','payslip_id','dept_payslip_id','Department Name'),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': '', 'datas': data}
kg_employee_payslip_wiz()
