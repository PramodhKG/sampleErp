...
class kg_employeesal_muster(osv.osv_memory):
		
	_name = 'kg.employeesal.muster'
	
	_columns = {
		
		'dep_id':fields.many2many('hr.department','kg_empsal_muster','dep_id','slip_id','Department Name'),
	...
	_defaults = {
		...
		'pay_sch': '7th',
		'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'kg.employeesal.muster', context=c),
	}
