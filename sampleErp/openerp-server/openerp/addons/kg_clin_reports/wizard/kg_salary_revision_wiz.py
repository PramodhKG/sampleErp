...
class kg_salary_revision_wiz(osv.osv_memory):
	_name = 'kg.salary.revision.wiz'
	_columns = {
		
		'dep_id':fields.many2many('hr.department','kg_salary_revision','leave_id','dept_leave_id','Department Name'),
