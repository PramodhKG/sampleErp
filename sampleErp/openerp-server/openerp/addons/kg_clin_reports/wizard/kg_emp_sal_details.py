...
class kg_emp_sal_details(osv.osv_memory):
	_name = 'kg.emp.sal.details'
	_columns = {
		
		'dep_id':fields.many2many('hr.department','kg_dept_sal_det','salary_id','salary_det','Department Name'),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'kg.emp.sal.details', 'datas': data}
kg_emp_sal_details()
