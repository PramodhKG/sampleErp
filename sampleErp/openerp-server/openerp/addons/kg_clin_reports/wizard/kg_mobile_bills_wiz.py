...
class kg_mobile_bills_wiz(osv.osv_memory):
		
	_name = 'kg.mobile.bills.wiz'
	_columns = {
		
		
		'filter': fields.selection([('filter_date', 'Date'),('filter_name','Employee Name')], "Filter by", required=True),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'kg.mobile.bills.report', 'datas': data}	
