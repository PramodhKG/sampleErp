...
class po_to_issue_wizard(osv.osv_memory):
		
	_name = 'po.to.issue.wizard'
	_columns = {
		
		'product_id': fields.many2many('product.product','po_to_issue','order_id','pro_id','Product Name'),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'po.order.issue', 'datas': data}	
