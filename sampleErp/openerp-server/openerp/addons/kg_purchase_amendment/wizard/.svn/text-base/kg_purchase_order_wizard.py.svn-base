...
class kg_purchase_order_wizard(osv.osv_memory):
	...
	_columns = {
		...
		'order':fields.many2many('purchase.order','kg_po_report_order','order_id','name','PO Order'),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'kg.purchase.order.report', 'datas': data}
