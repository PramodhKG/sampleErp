...
class kg_stock_picking(osv.osv):
	...
	def item_load(self,cr,uid,ids,context={}):
		...
		picking_id = picking_obj.search(cr, uid, [('state','!=','done'),('id','!=',stock_picking_record.id),('dep_name','=',dep_name),('type','=','internal')])
		print "picking_ids............................",picking_id
		if picking_id:
			raise osv.except_osv(
			...
			if stock_picking_record.move_lines:
				...
				for i in data_out:
					...
					if not data:
						...
						print "qty.............................",qty
						print "orig_qty.............................",orig_qty
						print "new_cons_qty....................",new_cons_qty
						uom = stock_uom
   ...
   'location_dest_id': fields.many2one('stock.location', 'Destination Location', required=True,
	...
	def unlink(self, cr, uid, ids, context=None):		
		...
		for t in move:
			...
			print "move type.........",move_rec.move_type
			print "picking type.......",move_rec.picking_id.type
			print "state..........",move_rec.state
			if move_rec.picking_id.type == 'in':				
