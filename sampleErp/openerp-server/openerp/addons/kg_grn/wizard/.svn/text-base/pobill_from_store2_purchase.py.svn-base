...
class pobill_from_store2_purchase(osv.osv_memory):
		
	_name = 'pobill.from.store'
	_columns = {
		
		'supplier':fields.many2many('res.partner','po_bill_sto_po','grn_id','supplier_id','Supplier'),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'pobill.from.store', 'datas': data}	
		

pobill_from_store2_purchase()
