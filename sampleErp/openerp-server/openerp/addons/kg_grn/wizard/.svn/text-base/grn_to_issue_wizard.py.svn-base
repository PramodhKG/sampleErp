...
class grn_to_issue_wizard(osv.osv_memory):
		
	_name = 'grn.to.issue.wizard'
	_columns = {
		
		'product_id': fields.many2many('product.product','grn_to_issue','order_id','pro_id','Product Name'),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'grn.to.issue', 'datas': data}	
