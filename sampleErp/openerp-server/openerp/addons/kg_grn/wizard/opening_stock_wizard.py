...
class opening_stock_wizard(osv.osv_memory):
		
	_name = 'opening.stock.wizard'
	_columns = {
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'opening.stock', 'datas': data}	
		

opening_stock_wizard()
