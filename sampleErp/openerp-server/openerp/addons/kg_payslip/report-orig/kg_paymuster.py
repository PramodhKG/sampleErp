...
class kg_paymuster(report_sxw.rml_parse):
	...
	def __init__(self, cr, uid, name, context=None):
		if context is None:
			context = {}
		super(kg_paymuster, self).__init__(cr, uid, name, context=context)
		self.query = ""
		self.period_sql = ""
...
report_sxw.report_sxw('report.kg.paymuster', 'hr.payslip', 
			'addons/kg_payslip/report/kg_paymuster.rml', 
			parser=kg_paymuster, header = False)
