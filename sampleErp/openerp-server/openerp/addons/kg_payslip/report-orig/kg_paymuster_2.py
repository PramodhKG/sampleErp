...
class kg_paymuster_2(report_sxw.rml_parse):
	
	_name = 'kg.paymuster_2'
	_inherit='hr.payslip'   

	def __init__(self, cr, uid, name, context=None):
		if context is None:
			context = {}
		super(kg_paymuster_2, self).__init__(cr, uid, name, context=context)
		self.query = ""
		self.period_sql = ""
...
report_sxw.report_sxw('report.kg.paymuster_2', 'hr.payslip', 
			'addons/kg_payslip/report/kg_paymuster_2.rml', 
			parser=kg_paymuster_2, header = False)
