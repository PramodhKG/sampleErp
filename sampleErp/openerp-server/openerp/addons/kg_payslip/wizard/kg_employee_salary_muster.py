...
class kg_employee_salary_muster(osv.osv_memory):
		
	_name = 'kg.employee.salary.muster'
	...
	_defaults = {
		...
		'pay_sch': '7th',
		'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'kg.employee.salary.muster', context=c),
	}
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'kg.emp.sal.muster', 'datas': data}


kg_employee_salary_muster()
