...
class kg_dep_wizard(osv.osv_memory):
		
	_name = 'kg.dep.wizard'
	_columns = {
		
		'dep_id':fields.many2many('kg.depmaster','kg_dep_report','dep_name','indent_id','Dep.Name'),
		'ind_id': fields.many2many('kg.depindent', 'indent_ref_report','indent_id','dep_name',
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'kg.depindent.report', 'datas': data}
