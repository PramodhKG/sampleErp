...
class mains_closing_stock_report(report_sxw.rml_parse):
	...
	def get_data(self,form):
		...
		self.cr.execute('''		
			   ...
			   group by sm.product_id, pc.name ''',('done',lo_type,form['date']))
		...
		gr_total=0.0
		gr_total1=0.0
		for position1, item in enumerate(data):
			...
			if lo_type == 'in':			
				...
				print"pos,it",position1, item
				print "category_id......................",pro_rec.categ_id.name
				
				
				print"pos,it",position1, item
			    
				new_data_list.append({'product_name':item['categ_name'],'type':1})
			...
			for position2, item2 in enumerate(data):
				print"pos2,it2,,,,,,,,,,,,,,,,,,,,,,,",position2, item2
				if position1 != position2:
					if item['categ_name'] == item2['categ_name']:
						item2['categ_name'] = " "
