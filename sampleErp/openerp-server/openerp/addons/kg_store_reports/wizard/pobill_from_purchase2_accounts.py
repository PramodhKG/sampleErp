...
class pobill_from_purchase2_accounts(osv.osv_memory):
		
	_name = 'pobill.from.purchase.wizard'
	_columns = {
		
		'supplier':fields.many2many('res.partner','po_bill_po_acc','grn_id','supplier_id','Supplier'),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'pobill.from.po.acc', 'datas': data}	
		

pobill_from_purchase2_accounts()
